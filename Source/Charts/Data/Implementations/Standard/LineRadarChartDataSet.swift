...
open class LineRadarChartDataSet: LineScatterCandleRadarChartDataSet, ILineRadarChartDataSet
{
	...
	/// The object that is used for secondary filling the area below the line.
	/// **default**: nil
	open var secondaryFill: Fill?
	/// The alpha value that is used for secondary filling the line surface,
	/// **default**: 1.0
	open var secondaryFillAlpha: CGFloat = 1.0

	/// The object that is used for filling the area around point selected.
	/// **default**: nil
	open var highlightFill: Fill?
